    ...
    public void add(Board board, MultipartFile[] files, Authentication authentication) throws IOException {
        ...
        if (files != null) {
            for (MultipartFile file : files) {
                ...
                // 실제 파일 저장
                // 부모 디렉토리 만들기
                String dir = STR."/Users/santa/Desktop/study/temp/prj2/\{board.getId()}";
                ...
                // 파일 경로
                String path = STR."/Users/santa/Desktop/study/temp/prj2/\{board.getId()}/\{file.getOriginalFilename()}";
